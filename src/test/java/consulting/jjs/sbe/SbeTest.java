                    ...
                    new Group("performanceFigures")
                            .addGroupValue(new GroupValue()
                                    ...
                                    .addGroup(new Group("acceleration")
                                            .addGroupValue(new GroupValue()
                                                    .addFieldValue(new SimpleFieldValue("mph", "30"))
                                                    .addFieldValue(new SimpleFieldValue("seconds", "4.0")))
                                            .addGroupValue(new GroupValue()
                                                    .addFieldValue(new SimpleFieldValue("mph", "60"))
                                                    .addFieldValue(new SimpleFieldValue("seconds", "7.5")))
                                            .addGroupValue(new GroupValue()
                                                    .addFieldValue(new SimpleFieldValue("mph", "100"))
                                                    .addFieldValue(new SimpleFieldValue("seconds", "12.2")))))
                            .addGroupValue(new GroupValue()
                                    .addFieldValue(new SimpleFieldValue("octaneRating", "99"))
                                    .addGroup(new Group("acceleration")
                                            .addGroupValue(new GroupValue()
                                                    .addFieldValue(new SimpleFieldValue("mph", "30"))
                                                    .addFieldValue(new SimpleFieldValue("seconds", "3.8")))
                                            .addGroupValue(new GroupValue()
                                                    .addFieldValue(new SimpleFieldValue("mph", "60"))
                                                    .addFieldValue(new SimpleFieldValue("seconds", "7.1")))
                                            .addGroupValue(new GroupValue()
                                                    .addFieldValue(new SimpleFieldValue("mph", "100"))
                                                    .addFieldValue(new SimpleFieldValue("seconds", "11.8")))))
            ))
            .datas(Arrays.asList(
